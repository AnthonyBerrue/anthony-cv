...
(function ($) {
   $.et_pb_simple_slider = function (el, options) {
      ...
      var $et_slider = $(el),
         ...
         et_active_slide = 0,
         $et_slider_arrows, $et_slider_prev, $et_slider_next, $et_slider_controls, et_slider_timer, controls_html = '',
         $progress_bar = null,
      ...
      function et_fix_slider_content_images() {
         ...
         $slide = $slide_image_container.closest('.et_pb_slide'), $slider = $slide.closest('.et_pb_slider'), slide_height = $slider.innerHeight(), image_height = parseInt(slide_height * 0.8);
   ...
   var $et_pb_slider = $('.et_pb_slider'),
      ...
      et_header_height, et_header_modifier, et_header_offset;
   $(document).ready(function () {
      ...
      function et_calculate_header_values() {
         et_header_height = $('#main-header').innerHeight(), et_header_modifier = et_header_height <= 90 ? et_header_height - 29 : et_header_height - 56, et_header_offset = $('#wpadminbar').length ? (et_header_modifier + $('#wpadminbar').innerHeight()) : et_header_modifier;
      }
